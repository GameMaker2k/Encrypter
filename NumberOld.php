...
if ($_POST['act'] == "decode") {
    if ($_GET['text'] == $ASCII_Title) {
        $This_Title = $Text_Title;
        $Done['This'] = "Yes";
    }
    if ($_POST['text'] == $ASCII_Title) {
        $This_Title = $Text_Title;
        $Done['This'] = "Yes";
    }
}
...
if ($_POST['act'] == "encode" || $_POST['act'] == "decode") {
    if ($Done['This'] != "Yes") {
        $This_Title = $ASCII_Title;
        $Done['This'] = "Yes";
    }
}
if ($_POST['act'] == "decode2") {
    if ($_GET['text'] == $ASCII_Title_Hex) {
        $This_Title = $Text_Title_Hex;
        $Done['This'] = "Yes";
    }
    if ($_POST['text'] == $ASCII_Title_Hex) {
        $This_Title = $Text_Title_Hex;
        $Done['This'] = "Yes";
    }
}
if ($_POST['act'] == "encode2") {
    if ($_GET['text'] == $ASCII_Title_Hex) {
        $This_Title = $Big_ASCII_Title_Hex;
        $Done['This'] = "Yes";
    }
    if ($_POST['text'] == $ASCII_Title_Hex) {
        $This_Title = $Big_ASCII_Title_Hex;
